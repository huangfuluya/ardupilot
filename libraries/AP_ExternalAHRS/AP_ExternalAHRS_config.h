...
#ifndef AP_EXTERNAL_AHRS_PIXHAWK6X_ENABLED
#define AP_EXTERNAL_AHRS_PIXHAWK6X_ENABLED (AP_EXTERNAL_AHRS_BACKEND_DEFAULT_ENABLED && HAL_ENABLE_DRONECAN_DRIVERS)
#endif
