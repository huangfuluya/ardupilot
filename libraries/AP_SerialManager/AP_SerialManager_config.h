...
// Emm_V5 step motor closed-loop driver (fixed 115200 baud)
#define AP_SERIALMANAGER_STEPMOTOR_BAUD       115200
#define AP_SERIALMANAGER_STEPMOTOR_BUFSIZE_RX 128
#define AP_SERIALMANAGER_STEPMOTOR_BUFSIZE_TX 128
