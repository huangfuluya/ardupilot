...
public:
    ...
    enum class Number : uint8_t {
        ...
        SQUARE =       29,  // SQUARE mode flies a fixed square path
...
private:
    static constexpr uint8_t NUM_WAYPOINTS = 4;

    Vector3f _waypoints[NUM_WAYPOINTS];
    uint8_t _leg_index = 0;
    bool _terrain_alt = false;
    bool _completed = false;
    uint32_t _reached_wp_time_ms = 0;
};
